...
<script src="/pub/home/js/jquery-3.1.1.js"></script>
  ...
  //alert(5);
    ...
    <div class="width90 center lvse_bg hidden center" id="my_ra">
       ...
       <p class="baise font12 center tcenter" style="width36%;margin-bottom:10px;"><?php echo date("Y-m-d H:i:s",$userinfo['last_punch_time']);?></p>
       <h3 class="tcenter shenl center font24" style="margin:0 auto">今日积分<span class="huangse"><?php echo ($today_point); ?></span>分</h3>
       <div class=" width75 center hidden" style="margin-bottom:30px; margin-top:20px;" id="cha_k">
           <div class="block center tcenter width45 fl lan_b boxSizing zp" style="color:#b5ebff;
padding:5px;border:1px solid #b5ebff">
                <font> 查看电子答案</font>
           </div>
                ...
                <div id="ji_f" class="hidden">
                    ...
                    <div class="width100 hidden">
                        <div class="width45 fl hidden">
                            ...
                            <a href="/index.php/Point/detail/id/<?php echo ($userinfo["id"]); ?>"><div class="fl boxSizing my_pai_o"  style="margin-left:3%;margin-top:6px;">
                    ...
                    <!--<div class="width100 hidden" style="margin-top:20px;">
                        <div class="width45 fl hidden">
                            ...
                            <img src="/pub/home/img/bzzx_pic1.png" class="fl width20">
                            <div class="fl boxSizing my_pai_o mypai_o" style="margin-left:5%;margin-top:6px;">
                                <h4 class="font100">我的排名2</h4>
                           </div>
                        </div>
                    ...
                    <div class="width100 hidden">
                        <div class="width45 fl hidden">
                            ...
                            <a href="/index.php/Point/detail/id/<?php echo ($userinfo["id"]); ?>"><div class="fl boxSizing my_pai_o" style="margin-left:5%;margin-top:6px;">
                                <h4 class="font100" style="margin-bottom:5px;color:#000">我的排名</h4>
   ...
   <div class=" width100 height100 fixed bContain center" style="left:0;top:0; z-index:9999; display:none; background:rgba(0,0,0,0.7); background-images:cover" id="sp_y">
        <iframe frameborder="0" src="<?php echo ($problem["video_result"]); ?>" width=100%; height="30%"class="block center tcenter" style="margin-top:40%"></iframe>
