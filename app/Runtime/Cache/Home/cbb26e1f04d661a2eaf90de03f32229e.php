  ...
  //alert(5);
    ...
    <div class="width100 bCover height100 hidden" id="colok_su">
        <div class="width100 hidden relative center width85" style="margin-top:-20px" >
            <img src="/pub/home/img/dkcg-bg1.png" class="width100 center">
            <p class="absolute tcenter block width100 su_p jiachu">打卡成功，恭喜获得10积分</p>
        </div>
        ...
        <div class="center hidden sudada huangborder boxSizing sp" style="margin-top:-20px;"> 
