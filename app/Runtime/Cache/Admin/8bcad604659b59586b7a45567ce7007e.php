...
<div id="content-header">
  <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> 首页</a> <a href="#" class="tip-bottom">修改红包</a>  </div>
  <h1>修改红包</h1>
</div>
    ...
    <div class="widget-box">
      ...
      <div class="widget-content">
        <div class="control-group">
         <form action="/hongbao/admin.php/Index/mod_hb_do/id/<?php echo ($info["id"]); ?>" method="post" class="form-horizontal" enctype="multipart/form-data">

            <div class="control-group">
              <label class="control-label">红包最大数 :</label>
              <div class="controls">
                <input type="text" class="span11" value="<?php echo ($info["max"]); ?>" name="max" id="title" />
              </div>
            </div>
          <div class="control-group">
              <label class="control-label">红包最小数 :</label>
              <div class="controls">
                <input type="text" class="span11" value="<?php echo ($info["min"]); ?>" name="min" id="title" />
              </div>
            </div>
