...
<head>
        ...
        <link rel="stylesheet" href="/hongbao/pub/admin/css/matrix-login.css" />
    ...
    <body>
        <div id="loginbox">            
            <form id="loginform" method="post" class="form-vertical" action="/hongbao/admin.php/Login/login_do">
				 <div class="control-group normal_text"> <h3><img src="/hongbao/pub/admin/img/logo.png" alt="Logo" /></h3></div>
        ...
        <script src="/hongbao/pub/admin/js/matrix.login.js"></script> 
    </body>
