...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="current">用户总览</a> </div>
    <h1>用户总览</h1>
  </div>
        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding over">
            <table style="overflow:hidden" class="table table-bordered data-table">
              ...
              <tbody>
                <?php if(is_array($admin)): foreach($admin as $k=>$v): ?><tr class="gradeX">
                  <td><?php echo ($k+1); ?></td>
                  <td><?php echo ($v["admin"]); ?></td>
                  <td><a href="/admin.php/Person/mod/id/<?php echo ($v["id"]); ?>">修改</a> / <a href="javascript:void()" onclick="del(<?php echo ($v["id"]); ?>)">删除</a></td>
...
<script type="text/javascript">
  function del(id){
    if(confirm("确定删除")){
      window.location="/admin.php/Person/del/id/"+id;
    }
  }
</script>
<!--Footer-part-->
