...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> 首页</a> <a href="#" class="current">题目总览</a> </div>
    <h1>题目总览</h1>
  </div>
        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding over">
            <table style="overflow:hidden" class="table table-bordered data-table">
              ...
              <tbody>
                <?php if(is_array($problem)): foreach($problem as $k=>$v): ?><tr class="gradeX">
                  <td><?php echo ($k+1); ?></td>
                  <td><?php echo ($v["title"]); ?></td>
                  <td><?php echo date("Y-m-d",$v['add_time']);?></td>
                  <td><a href="/admin.php/Problem/answer/id/<?php echo ($v["id"]); ?>">详情</a></td>
                  <td><a href="/admin.php/Problem/mod/id/<?php echo ($v["id"]); ?>">修改</a> / <a href="javascript:void()" onclick="del(<?php echo ($v["id"]); ?>)">删除</a></td>
...
<script type="text/javascript">
  function del(id){
    if(confirm("确定删除")){
      window.location="/admin.php/Problem/del/id/"+id;
    }
  }
</script>
<!--Footer-part-->
