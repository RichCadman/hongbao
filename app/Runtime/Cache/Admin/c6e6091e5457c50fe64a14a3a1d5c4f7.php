...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> 首页</a> <a href="#" class="current">推荐人信息</a> </div>
    <h1>推荐人信息</h1>
  </div>
        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding over">
            <table  style="overflow:hidden" class="table table-bordered data-table">
              ...
              <tbody>
                <?php if(is_array($tuijian)): foreach($tuijian as $k=>$v): ?><tr class="gradeX">
                  <td><?php echo ($k+1); ?></td>
				          <td><?php echo ($v["wx_name"]); ?></td>
                  <td><?php echo ($v["money"]); ?></td>
                  <td><?php echo ($v["fl_jine"]); ?></td>
                  <td><a href="/hongbao/admin.php/Index/mod_tj/id/<?php echo ($v["id"]); ?>">修改</a> / <a href="javascript:void()" onclick="del(<?php echo ($v["id"]); ?>)">删除</a></td>
...
<script type="text/javascript">
  function del(id){
    if(confirm("确定删除")){
      window.location="/hongbao/admin.php/Index/del_tj/id/"+id;
    }
  }
</script>
<!--Footer-part-->
