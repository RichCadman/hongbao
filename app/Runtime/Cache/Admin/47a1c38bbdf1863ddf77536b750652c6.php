...
<div id="content-header">
  <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> 首页</a> <a href="#" class="tip-bottom">添加题目</a>  </div>
  <h1>添加题目</h1>
</div>
    ...
    <div class="widget-box">
      ...
      <div class="widget-content">
        <div class="control-group">
         <form action="/admin.php/Problem/add_do" method="post" class="form-horizontal" enctype="multipart/form-data">
            ...
            <div class="controls">
              <div  data-date="" class="input-append date datepicker">
                <input type="text" value="" name="add_time" id="add_time" data-date-format="yyyy-mm-dd" class="span11" >
            ...
            <label class="control-label">添加题目</label>
            <div class="controls">
              <input type="file" class="span11" name="file[]" id="title" />
            </div>
            
            <div class="control-group">
              <label class="control-label">添加视频解析路径 :</label>
              <div class="controls">
                <input type="text" class="span11" name="video_result" />
              </div>
            </div>
            
            <label class="control-label">添加电子版解析</label>
            <div class="controls">
              <input type="file" class="span11" name="file[]" id="title" />
            </div>
