...
<div id="content-header">
  <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> 首页</a> <a href="#" class="tip-bottom">添加分享内容</a>  </div>
  <h1>添加分享内容</h1>
</div>
    ...
    <div class="widget-box">
      ...
      <div class="widget-content">
        <div class="control-group">
         <form action="/admin.php/Share/add_do" method="post" class="form-horizontal" enctype="multipart/form-data">
            <label class="control-label">添加分享内容</label>
            <div class="controls">
