    ...
    <div class="widget-box">
      ...
      <div class="widget-content">
        <div class="control-group">
         <form action="/hongbao/admin.php/Index/mod_tj_do/id/<?php echo ($info["id"]); ?>" method="post" class="form-horizontal" enctype="multipart/form-data">

            <div class="control-group">
              <label class="control-label">推荐人名称 :</label>
              <div class="controls">
                <input type="text" class="span11" value="<?php echo ($info["wx_name"]); ?>" name="wx_name" id="title" />
              </div>
            </div>
          <div class="control-group">
              <label class="control-label">红包 :</label>
              <div class="controls">
                <input type="text" class="span11" value="<?php echo ($info["money"]); ?>" name="money" id="title" />
              </div>
            </div>
             <div class="control-group">
              <label class="control-label">返利金额 :</label>
              <div class="controls">
                <input type="text" class="span11" value="<?php echo ($info["fl_jine"]); ?>" name="fl_jine" id="title" />
              </div>
            </div>
