...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i>菜单栏</a>
  <ul>
    <li> <a href="/admin.php/Index/kehu.html"><i class="icon icon-home"></i> <span>客户信息</span></a> </li>
    <li> <a href="/admin.php/Index/tuijian.html"><i class="icon icon-home"></i> <span>推荐人信息</span></a> </li>
    ...
    <div class="widget-box">
      ...
      <div class="widget-content">
        <div class="control-group">
         <form action="/admin.php/Index/mod_ku_do/id/<?php echo ($info["id"]); ?>" method="post" class="form-horizontal" enctype="multipart/form-data">

            <div class="control-group">
              <label class="control-label">客户名称 :</label>
              <div class="controls">
                <input type="text" class="span11" value="<?php echo ($info["names"]); ?>" name="names" id="title" />
              </div>
            </div>
          <div class="control-group">
              <label class="control-label">状态 :</label>
              <div class="controls">
                <input type="text" class="span11" value="<?php echo ($info["stage"]); ?>" name="stage" id="title" />
              </div>
            </div>
