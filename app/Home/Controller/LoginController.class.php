...
class LoginController extends Controller {
	...
	public function login(){
		...
		//echo "13";exit;
		$appid = "wxec9f9ed5706a50a6";
        $url = 'https://open.weixin.qq.com/connect/oauth2/authorize?appid='.$appid.'&redirect_uri=http://www.dingzankj.com/hongbao/index.php/Login/login_do&response_type=code&scope=snsapi_userinfo&state=STATE#wechat_redirect';
	   header("Location:".$url);
	}
	...
	public function login_share($my_openId){//接收分享人的openID
		$appid = "wxec9f9ed5706a50a6";
        $url = 'https://open.weixin.qq.com/connect/oauth2/authorize?appid='.$appid.'&redirect_uri=http://www.dingzankj.com/hongbao/index.php/Login/login_share_do/my_openId/'.$my_openId.'&response_type=code&scope=snsapi_userinfo&state=STATE#wechat_redirect';
	   header("Location:".$url);
	}
